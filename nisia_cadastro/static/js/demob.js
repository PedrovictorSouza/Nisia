...
function grabFormData() {
    ...
    let regInsta = document.querySelector('input[type="text"][name="instagram"]').value;
...
function rotatePentagon(x) {
    ...
    if (x === 3) {
        ...
        document.getElementById('ecossistem__texto').innerHTML = "O INÍCIO DO CICLO.<br><br><span class=\"meetings\"><p>Erradicando tabus: tecnologia sem gênero</p><p>Construindo mindset digital a partir de ciencias humanas</p><p>A ponte com o mercado de trabalho</p><p>Como evitar a obsolescência de currículo</p><p>Tolkit didático</p></span>";
        ...
        document.getElementById('cir').setAttribute("cy", 137);
        document.getElementById('ecossistem__texto').innerHTML = "O GIVE BACK.<br> <span class=\"meetings\">Repassar aprendizado<br>O apoio às iniciativas de base<br>O contato empresa-escola<br>A retroalimentação do ciclo com a observação dos resultados.</span> ";
        countTotal += 1;
        ...
        document.getElementById('ecossistem__texto').innerHTML = "GAME ON<br><br><span class=\"meetings\">O mercado de trabalho tradicional, as startups e o profissional freelancer.<br>planejamento de carreira<br>a importância de se conhecer as estruturas de um negócio<br>as habilidades complementares e indispensáveis<br>empatia, atitude e resiliencia</span>";
        countTotal += 1;
