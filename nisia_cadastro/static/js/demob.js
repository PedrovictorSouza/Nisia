...
function grabFormData() {
  ...
  let regEmail = document.querySelector('input[type="email"][name="email"]')
    .value;
  let regPhone = document.querySelector('input[type="text"][name="phone"]')
    .value;
  let regInsta = document.querySelector('input[type="text"][name="instagram"]')
    .value;
...
function rotatePentagon(x) {
  ...
  if (x === 3) {
    ...
    document.getElementById("ecossistem__texto").innerHTML =
      'O INÍCIO DO CICLO.<br><br><span class="meetings"><p>Erradicando tabus: tecnologia sem gênero</p><p>Construindo mindset digital a partir de ciencias humanas</p><p>A ponte com o mercado de trabalho</p><p>Como evitar a obsolescência de currículo</p><p>Tolkit didático</p></span>';
    ...
    document.getElementById("ecossistem__texto").innerHTML =
      'O DESENVOLVIMENTO<br><span class="meetings">Os primeiros passos - os caminhos possíveis. como e por onde começar?<br>Tecnologia não é tudo igual<br>A importância da multidisciplinaridade<br>A dinâmica do conhecimento digital e a necessidade do estudo constante<br>O aprender além, muito além, da sala de aula<br>As referências</span>';
    ...
    document.getElementById("cir").setAttribute("cy", 137);
    document.getElementById("ecossistem__texto").innerHTML =
      'O GIVE BACK.<br> <span class="meetings">Repassar aprendizado<br>O apoio às iniciativas de base<br>O contato empresa-escola<br>A retroalimentação do ciclo com a observação dos resultados.</span> ';
    countTotal += 1;
    ...
    document.getElementById("ecossistem__texto").innerHTML =
      'GAME ON<br><br><span class="meetings">O mercado de trabalho tradicional, as startups e o profissional freelancer.<br>planejamento de carreira<br>a importância de se conhecer as estruturas de um negócio<br>as habilidades complementares e indispensáveis<br>empatia, atitude e resiliencia</span>';
    countTotal += 1;
    ...
    document.getElementById("cir").setAttribute("cy", 670);
    document.getElementById("ecossistem__texto").innerHTML =
      'O RESULTADO<br><br><span class="meetings"> A compreensão da dinâmica: semear, cuidar, colher, multiplicar<br>O entendimento histórico do funcionamento desse mercado: Os tabus, a resistencia, o estereótipo, as desigualdades<br>A necessidade de multiplicar talentos e apoiar escolas<br>A construção de um ambiente acolhedor<br>A marca empregadora e inspiradora</span>';
    countTotal += 1;
    ...
    if (imageA() === "ana") {
      for (var i = 0; i < change.length; i++) {
        change[i].style.background =
          "url(/static/img/nisia_home_ana.png) no-repeat center";
        change[i].style.backgroundSize = "cover";
      }
    } else {
      for (var i = 0; i < change.length; i++) {
        change[i].style.background =
          "url(/static/img/nisia_home.png) no-repeat center";
        change[i].style.backgroundSize = "cover";
      }
    }
  }, 3000);
